...
if ( isset($_POST['save']) ) {
	...
	$_data['d_mcontent'] = $_POST['d_content'];
	$_data['d_mscontent'] = ($_POST['d_scontent'] == '') ? cut_str(clear_html($_POST['d_content']),100) : $_POST['d_scontent'];
	...
	$sql = 'insert into cms_detail ('.$str[0].') values ('.$str[1].')';
	if (mysql_query($sql)) {
		$order = mysql_insert_id();
		if ( $_POST['d_order'] == 0 ) {
			mysql_query('update cms_detail set d_order = '.$order.' where id = '.$order);
		}
		alert_href('详情添加成功!','cms_detail_add.php?cid='.$_GET['cid']);
	} else {
		alert_back('详情添加失败!');
	}
}
					...
					<form method="post">
						<div class="line-big">
							<div class="form-group x6">
								...
								<div class="field">
									<input id="d_name" class="input" name="d_name" type="text" size="60" data-validate="required:请输入详情名称" value="" />
							...
							<div class="form-group x6 form-auto">
								...
								<div class="field">
									<input id="d_picture" class="input" name="d_picture" type="text" size="60" value="" />
							...
							<div class="form-group x6">
								...
								<div class="field">
									<select id="d_parent" class="input" data-validate="required:请选择上级频道" name="d_parent">
							...
							<div class="form-group x3">
								...
								<div class="field">
									<label class="btn"><input id="d_rec" name="d_rec" type="radio" value="0" checked="checked"/>否</label>
									<label class="btn"><input name="d_rec" type="radio" value="1" />是</label>
							...
							<div class="form-group x3">
								...
								<div class="field">
									<label class="btn"><input id="d_hot" name="d_hot" type="radio" value="0" checked="checked"/>否</label>
									<label class="btn"><input name="d_hot" type="radio" value="1" />是</label>
							...
							<div class="form-group x12">
								...
								<div class="field">
									<textarea id="d_scontent" class="input" name="d_scontent" row="5" /></textarea>
							...
							<div class="form-group x12">
								...
								<div class="field">
									<textarea id="d_content" class="input" name="d_content" /></textarea>
							...
							<div class="form-group x6">
								...
								<div class="field">
									<textarea id="d_slideshow" class="input" name="d_slideshow" row="5" /></textarea>
							...
							<div class="form-group x6">
								...
								<div class="field">
									<textarea id="d_video" class="input" name="d_video" row="5" /></textarea>
							...
							<div class="form-group x4">
								...
								<div class="field">
									<input id="d_keywords" class="input" name="d_keywords" type="text" size="60" value="" />
							...
							<div class="form-group x4">
								...
								<div class="field">
									<input id="d_description" class="input" name="d_description" type="text" size="60" value="" />
							...
							<div class="form-group x4">
								...
								<div class="field">
									<input id="d_seoname" class="input" name="d_seoname" type="text" size="60" value="" />
							...
							<div class="form-group form-auto x4">
								...
								<div class="field">
									<input id="d_file" class="input" name="d_file" type="text" size="30" value="" />
							...
							<div class="form-group x3">
								...
								<div class="field">
									<input id="d_link" class="input" name="d_link" type="text" size="60" value="" />
							...
							<div class="form-group x2">
								...
								<div class="field">
									<input id="d_order" class="input" name="d_order" type="text" size="60" data-validate="required:必填,plusinteger:请输入排序数字" value="0" />
							...
							<div class="form-group form-auto x3">
								...
								<div class="field">
									<input id="d_author" class="input" name="d_author" type="text" size="12" value="" />
									<input id="d_source" class="input" name="d_source" type="text" size="12" value="" />
