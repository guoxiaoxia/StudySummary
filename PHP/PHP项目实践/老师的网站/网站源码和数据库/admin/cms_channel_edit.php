	...
	<div class="container">
		<div class="line-big">
			...
			<div class="xx105">
				...
				<div class="bd-1">
					<?php
					$result = mysql_query('select * from cms_channel where id = '.$_GET['id']);
					...
					<form method="post">
						<div class="line-big">
							...
							<div class="form-group x5 form-auto">
								...
								<div class="field">
									<input id="c_nname" class="input" name="c_nname" type="text" size="30" value="<?php echo $row['c_nname'];?>" />
							...
							<div class="form-group form-auto x6">
								...
								<div class="field">
									<input id="c_cmodel" class="input" name="c_cmodel" type="text" size="40" data-validate="required:请选择或输入频道模型" value="<?php echo $row['c_cmodel'];?>" />
									<select class="input" onChange="c_cmodel.value=this.value;c_cmodel.focus();c_cmodel.blur();">
										...
										<option value="c_article.php" >文章</option>
							...
							<div class="form-group x2">
								...
								<div class="field">
									<input id="c_page" class="input" name="c_page" type="text" size="60" data-validate="required:必填,plusinteger:请输入合法分页数字" value="<?php echo $row['c_page'];?>" />
							...
							<div class="form-group x2">
								...
								<div class="field">
									<input id="c_order" class="input" name="c_order" type="text" size="60" data-validate="required:必填,plusinteger:请输入合法排序数字" value="<?php echo $row['c_order'];?>" />
							...
							<div class="form-group x4">
								...
								<div class="field">
									<input id="c_link" class="input" name="c_link" type="text" size="60" value="<?php echo $row['c_link'];?>" />
