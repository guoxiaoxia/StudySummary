		...
		<div class="line-big">
			<div class="x12">
				<ul class="list-group">
					...
					?>
					<li><span class="fr badge"><?php echo date('Y-m-d',$row['d_date']) ?> </span><a href="<?php echo d_url($row['id'])?>" target="_blank" title="<?php echo $row['d_name'];?>"><?php echo cut_str($row['d_name'],60);?></a></li>
					<?php
					}
					?>
				</ul>
